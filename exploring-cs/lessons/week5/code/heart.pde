...
int dir = -1;         // controls whether the heart is getting lighter or darker
int heartTint = 255;  // // sets the hearts tint to white

void setup() {
  size(500, 500); // sets the canvas size to 500x500
...
// raws a heart, with the current heartTint
void heart() {
  fill(heartTint, 0, 0);
